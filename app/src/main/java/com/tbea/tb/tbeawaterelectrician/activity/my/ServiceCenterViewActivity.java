...
public class ServiceCenterViewActivity extends TopActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        String url = "http://www.u-shang.net/enginterface/index.php/Apph5/userhelp?questionid="+getIntent().getStringExtra("id");
