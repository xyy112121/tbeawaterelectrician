package com.tbea.tb.tbeawaterelectrician.activity.thenLive;
...
public class TakeViewActivity extends TopActivity{
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        String url = "http://www.u-shang.net/enginterface/index.php/Apph5/taskdetail?taskid="+id;
