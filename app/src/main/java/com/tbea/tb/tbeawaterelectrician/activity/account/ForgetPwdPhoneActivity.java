...
import com.tbea.tb.tbeawaterelectrician.activity.my.BindingNewPhoneActivity;
...
public class ForgetPwdPhoneActivity extends TopActivity {
            ...
            public void onClick(View v) {
                ...
                new Thread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        try {
                            RspInfo1 result = action.sendCode(mobile,"TBEAENG001001006000");
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    RspInfo1 re = userAction.validateCode(mobile,verifycode);
