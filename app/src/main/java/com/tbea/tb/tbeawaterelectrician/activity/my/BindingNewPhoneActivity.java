    ...
    private void  listener(){
        findViewById(R.id.myphone_edit_finish).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                String mobile = ((EditText)findViewById(R.id.new_phone)).getText()+"";
                String code = ((EditText)findViewById(R.id.new_code)).getText()+"";
                updateNewPhone(mobile,code);
            }
        });
            ...
            public void onClick(View v) {
                ...
                new Thread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        try {
                            RspInfo1 result = action.sendCode(mobile,"TBEAENG005001005001");
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    RspInfo1 re = userAction.updateNewPhone(mobile,verifycode);
